...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.clientSecret, "client-secret", "secret", "OAuth2 client secret of this application.")
	c.Flags().StringVar(&a.redirectURI, "redirect-uri", "http://127.0.0.1:5555/callback", "Callback URL for OAuth2 responses.")
	c.Flags().StringVar(&issuerURL, "issuer", "http://accounts.example.com", "URL of the OpenID Connect issuer.")
